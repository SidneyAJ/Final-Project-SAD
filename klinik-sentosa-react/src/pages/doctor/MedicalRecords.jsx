...
import { FileText, Calendar, User, Search, Filter, ChevronDown, ChevronUp, Pill, FileCheck } from 'lucide-react'
            ...
            <ScrollReveal>
                <div className="bg-gradient-to-r from-primary-600 to-primary-800 rounded-3xl p-8 text-white shadow-xl relative overflow-hidden">
                    ...
                    <div className="relative z-10 flex items-center gap-4">
                        ...
                        <div>
                            <h1 className="text-3xl font-bold mb-2">Riwayat Pemeriksaan</h1>
                            <p className="text-primary-100">Semua rekam medis pasien yang telah Anda buat</p>
                        </div>
                    </div>
                </div>
            </ScrollReveal>
                    ...
                    <div className="flex items-center gap-4">
                        <div className="flex-1 relative">
                            ...
                            <input
                                ...
                                className="w-full pl-12 pr-4 py-3 border border-gray-200 rounded-xl focus:ring-2 focus:ring-primary-500/20 focus:border-primary-500 outline-none"
                            />
                        </div>
                    </div>
                </div>
            ...
            <div className="space-y-4">
                <div className="flex items-center justify-between">
                    <h3 className="text-lg font-bold text-gray-800">
                        Daftar Rekam Medis ({filteredRecords.length})
                    </h3>
                </div>
                    ...
                    <ScrollReveal>
                        <div className="bg-white rounded-2xl shadow-lg p-12 text-center border border-gray-100">
                            ...
                            <h3 className="text-lg font-semibold text-gray-800 mb-2">
                                {searchTerm ? 'Tidak ada hasil pencarian' : 'Belum ada rekam medis'}
                            </h3>
                            <p className="text-gray-600">
                                {searchTerm ? 'Coba kata kunci yang berbeda' : 'Rekam medis akan muncul setelah Anda membuat pemeriksaan pasien'}
                            </p>
                        </div>
                    </ScrollReveal>
                ) : (
                                    ...
                                    <div className="flex items-center justify-between">
                                        <div className="flex-1">
                                            <div className="flex items-center gap-3 mb-3">
                                                ...
                                                <div>
                                                    <h4 className="font-bold text-gray-800">{record.patient_name}</h4>
                                    ...
                                    <div className="px-6 pb-6 pt-0 border-t border-gray-100 bg-gray-50 space-y-4">
                                        {record.treatment && (
                                            <div>
                                                ...
                                                <p className="text-gray-700 bg-white p-4 rounded-lg">{record.treatment}</p>
                                            </div>
                                        )}
                                        {record.notes && (
                                            <div>
