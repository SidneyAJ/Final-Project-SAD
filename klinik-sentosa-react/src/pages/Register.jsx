...
export default function Register() {
    ...
    const validateStep = (step) => {
        if (step === 1) {
            if (!formData.namaLengkap || !formData.nik || !formData.tanggalLahir || !formData.jenisKelamin) {
                showToast('Mohon lengkapi semua data wajib!\n\n• Nama Lengkap\n• NIK\n• Tanggal Lahir\n• Jenis Kelamin')
                return false
            }
        ...
        if (step === 2) {
            if (!formData.email || !formData.nomorHP || !formData.alamat) {
                showToast('Mohon lengkapi semua data wajib!\n\n• Email\n• Nomor HP\n• Alamat')
                return false
            }
    ...
    const handleSubmit = async (e) => {
        ...
        if (!formData.username || !formData.password || !formData.confirmPassword) {
            showToast('Mohon lengkapi semua data akun!')
            return
        }
        ...
        try {
            ...
            if (response.ok) {
                showToast('Registrasi berhasil!\nSilakan login untuk melanjutkan.', 'success')
                ...
                if (data.error && data.error.includes('email') && data.error.includes('exists')) {
                    ...
                    errorMessage = data.error || data.message || 'Terjadi kesalahan saat mendaftar.'
                }
                            ...
                            {[
                                ...
                                <div key={step.num} className="flex items-center">
                                    ...
                                    <div className="flex flex-col items-center relative group">
                                        {/* Circle Wrapper for Perfect Centering */}
                                        <div className="relative w-20 h-20 flex items-center justify-center">
                                            ...
                                            {/* Main Circle */}
                                            <div className={`relative w-14 h-14 rounded-full flex items-center justify-center font-bold text-xl transition-all duration-500 z-10 ${currentStep >= step.num
                                    ...
                                    {/* Connector Line */}
                                    {index < 2 && (
                                        <div className="relative mx-2 md:mx-4 w-16 md:w-32 self-start mt-10">
                                            {/* Base Line */}
