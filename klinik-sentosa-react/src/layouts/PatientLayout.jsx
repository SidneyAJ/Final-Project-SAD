...
export default function PatientLayout() {
    ...
    const menuItems = [
        ...
        { path: '/patient/appointments', icon: Calendar, label: 'Janji Temu' },
                ...
                <div className="flex flex-col flex-grow bg-white border-r border-gray-200 pt-5 pb-4 overflow-y-auto">
                    ...
                    <div className="px-6 mb-6">
                        <div className="bg-gradient-to-br from-primary-50 to-secondary-50 rounded-2xl p-4 border border-primary-100">
                            <div className="flex items-center gap-3">
                                <div className="w-12 h-12 bg-gradient-to-br from-primary-500 to-secondary-500 rounded-xl flex items-center justify-center text-white font-bold text-lg shadow-lg">
                    ...
                    <div className="px-4 mt-6">
                        <button
                            ...
                            className="w-full flex items-center gap-3 px-4 py-3 text-primary-100 hover:bg-primary-800 hover:text-white rounded-xl transition-all font-medium group"
                        >
